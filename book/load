...
## Next section
A core functionality of ancpBIDS is to extract information from datasets. We will explain you how to perform basic queries, advance queries and how to query for metadata.
